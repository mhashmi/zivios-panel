 ...
 * @version		$Id: GroupContainer.php 908 2008-08-25 11:03:00Z fkhan $
 * @subpackage  Validator
 **/

class Zivios_Validate_GroupContainer extends Zivios_Validate
{
	...
	private function _validateAdd()
	{
		...
		if ($this->msg = $param->setValue($this->fobj->group_cont))
			return $this->msg;
	}
