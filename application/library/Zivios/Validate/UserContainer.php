 ...
 * @version		$Id: UserContainer.php 908 2008-08-25 11:03:00Z fkhan $
 * @subpackage  Validator
 **/

class Zivios_Validate_UserContainer extends Zivios_Validate
{
	...
	private function _validateAdd()
	{
		...
		if ($this->msg = $param->setValue($this->fobj->user_cont))
			return $this->msg;
	}
